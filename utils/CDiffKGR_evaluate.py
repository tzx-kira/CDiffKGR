...
def test(model, user_dict, n_params):
    ...
    for u_batch_id in tqdm(range(n_user_batchs)):
        ...
        ###
        # u_g_embeddings = user_gcn_emb[0][user_batch]
        # u_g_embeddings_1 = user_gcn_emb[1][user_batch]
        ###
        if batch_test_flag:
            # batch-item test
            ...
            for i_batch_id in range(n_item_batchs):
                ...
                ###
                # i_g_embddings = entity_gcn_emb[0][item_batch]
                # i_g_embddings_1 = entity_gcn_emb[1][item_batch]
                ###
                i_rate_batch = model.rating(u_g_embeddings, i_g_embddings)
                ###
                # i_rate_batch = model.rating([u_g_embeddings,u_g_embeddings_1], [i_g_embddings,i_g_embddings_1])
                ###
